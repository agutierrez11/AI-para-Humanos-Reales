...
## 🗂️ Las 5 capas del conocimiento

| Capa | Tema | Conceptos |
|------|------|-----------|
| [1 — El modelo](./capa1-modelo/) | Qué es y cómo funciona | LLM, tokens, contexto, temperatura, alucinaciones |
| [2 — Hablarle](./capa2-prompts/) | Cómo darle instrucciones | Prompt, system prompt, rol, few-shot |
| [3 — Ampliar](./capa3-capacidades/) | Cómo extender sus capacidades | MCP, RAG, embeddings, tools/skills, memoria |
| [4 — Orquestar](./capa4-orquestacion/) | Cómo combinarlo todo | Agente, workflow, chain of thought, human-in-the-loop |
| [5 — Evaluar](./capa5-evaluacion/) | Cómo saber si funciona bien | Evaluación, benchmark, grounding, sesgo |
...
### Capa 1 — El modelo
- [LLM](./capa1-modelo/llm.md) ✅
- [Tokens](./capa1-modelo/tokens.md) ✅
- [Contexto](./capa1-modelo/contexto.md) ✅
- [Temperatura](./capa1-modelo/temperatura.md) ✅
- [Alucinaciones](./capa1-modelo/alucinaciones.md) ✅

### Capa 2 — Hablarle
- [Prompt](./capa2-prompts/prompt.md) ✅
- [System Prompt](./capa2-prompts/system-prompt.md) ✅
- [Rol](./capa2-prompts/rol.md) ✅
- [Few-Shot](./capa2-prompts/few-shot.md) ✅

### Capa 3 — Ampliar
- [MCP](./capa3-capacidades/mcp.md) ✅
- [RAG](./capa3-capacidades/rag.md) ✅
- [Embeddings](./capa3-capacidades/embeddings.md) ✅
- [Tools / Skills](./capa3-capacidades/tools-skills.md) ✅
- [Memoria](./capa3-capacidades/memoria.md) ✅

### Capa 4 — Orquestar
- [Agente](./capa4-orquestacion/agente.md) ✅
- [Workflow](./capa4-orquestacion/workflow.md) ✅
- [Chain of Thought](./capa4-orquestacion/chain-of-thought.md) ✅
- [Human-in-the-Loop](./capa4-orquestacion/human-in-the-loop.md) ✅

### Capa 5 — Evaluar
- [ ] Evaluación 🔓 *abierto para PR*
- [ ] Benchmark 🔓 *abierto para PR*
- [ ] Grounding 🔓 *abierto para PR*
- [ ] Sesgo (Bias) 🔓 *abierto para PR*
